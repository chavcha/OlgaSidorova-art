...
const productDatabase = {
  ...
  19: {
    ...
    fullDescription: `
            <p>Картина «Обережная» раскрывает тему защиты, интуитивной мудрости и бережного отношения к внутреннему миру человека. В работе ощущается гармония между человеческим образом и живой природой.</p>
            <p>Теплая палитра и пластичные линии создают состояние уюта, доверия и мягкой силы. Композиция строится как единое поле энергии, в котором каждый элемент поддерживает и усиливает общий смысл.</p>
            <p>Работа выполнена маслом на холсте, благодаря чему изображение приобретает глубину, фактуру и выразительность. Картина станет эмоциональным акцентом в интерьере и источником спокойствия.</p>
        `,
  },
  20: {
    id: 20,
    ...
    fullDescription: `
            <p>«Реальная иллюзия» исследует тонкую грань между объективным восприятием и внутренним видением. Работа построена на сочетании символов, абстрактных форм и эмоционально насыщенной цветовой среды.</p>
            <p>Композиция ведет взгляд через несколько визуальных уровней, создавая эффект движения от внешней формы к скрытому смыслу. Контраст света и плотных цветовых масс подчеркивает идею того, что реальность всегда многослойна.</p>
            <p>Картина написана маслом на холсте с выразительной фактурой и динамичной пластикой мазка. Это произведение станет сильным современным акцентом в пространстве и поводом для размышлений.</p>
        `,
  },
  21: {
    id: 21,
    ...
    fullDescription: `
            <p>Услуга печати картин на холсте позволяет выбрать подходящий размер под ваш интерьер. Используются качественные материалы с насыщенной цветопередачей и аккуратной натяжкой.</p>
            <p>Минимальная стоимость начинается от 3 680 ₽ за размер 20x27 см. Также доступны форматы 25x33, 30x39, 35x45, 40x54 и 45x60 см.</p>
            <p>В карточке размещены видео с примером исполнения и фото с актуальным прайсом по размерам. Для заказа можно перейти в раздел покупки и связаться удобным способом.</p>
        `,
        ...
        <div class="product-wrapper">
            ...
            <div class="product-info-section">
                ...
                <div class="product-price-section">
                    <div class="product-price">${product.pricePrefix ? product.pricePrefix + " " : ""}${formatPrice(product.price)} ₽</div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // In file:// mode arrows switch only hash, so re-render product on hash change.
